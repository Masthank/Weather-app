...
// let apikey="708yHM6vydkRybbWHFGmPA==Hq2ZoVlqImvLTtga";

// let url="https://api.api-ninjas.com/v1/weather?city=";

const search=document.getElementById("query");
const APILINK='https://api.api-ninjas.com/v1/weather?x-api-key=708yHM6vydkRybbWHFGmPA==Hq2ZoVlqImvLTtga&city=';
...
form.addEventListener("submit",(e)=>{
    ...
    const SEARCHAPI = 'https://api.api-ninjas.com/v1/weather?x-api-key=708yHM6vydkRybbWHFGmPA==Hq2ZoVlqImvLTtga&city=';
    if(searchItem){
